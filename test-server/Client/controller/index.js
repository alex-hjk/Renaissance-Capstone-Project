...
class ClientController {
    ...
    resultsRetrieval(request){
        ...
        // Note a Galois matrix in sent in the request here. We convert it to a bigint[][] before sending it to the service layer. In the actual implemnetation, The framework accepts a bigint[][]
