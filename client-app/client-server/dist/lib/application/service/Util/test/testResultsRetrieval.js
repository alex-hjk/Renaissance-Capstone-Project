"use strict";
const ResultsRetrievalUtil = require('../ResultsRetrieval/ResultsRetrievalUtil');
const testResultsRetrieval = () => {
    ...
    console.log(realAnswerArray, `test passed: ${realAnswerArray === ['95917348524570763086840225464814582534913519306']}`);
